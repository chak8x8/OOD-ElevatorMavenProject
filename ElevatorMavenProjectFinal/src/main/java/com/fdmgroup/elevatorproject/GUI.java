...
import javax.swing.Timer;
	...
	public class GUI implements Runnable
	{
		...
		private int maxFloor = Const.maxFloor; // Maximum number of floors
		private int minFloor = Const.minFloor; // Minimum number of floors
		private int numLift = Const.numOfElevators;
		...
		public GUI(final List<Elevator> elevators)
		{
			...
			jframe.setTitle("Simulation for " + Const.numOfFloors + " Floors and " + numLift + " Elevators");
		...
		private void startGraphics()
		{
			...
			jframe.add(new JComponent()
			{
				...
				{
					int numFloors = Const.numOfFloors;
		...
		private void drawBackgroundGrid(Graphics graphics, int height, int width)
		{
			...
			int levelHeight = height / (Const.numOfFloors);
